...
public class BasicBucketsTaxableFirstTests
{
    ...
    [InlineData(100, 40, 0,0,200000)]
    [InlineData(40, 60, 0,0,160000)]
    [InlineData(60, 60, 0,0,180000)]
    [InlineData(80, 60, 0,0,200000)]
    [InlineData(100, 60, 20000,0,200000)]
    [InlineData(40, 80, 0,0,180000)]
    [InlineData(60, 80, 0,0,200000)]
    [InlineData(80, 80, 20000,0,200000)]
    [InlineData(100, 80, 40000,0,200000)]
    [InlineData(40, 100, 0,0,200000)]
    [InlineData(60, 100, 20000,0,200000)]
    [InlineData(80, 100, 40000,0,200000)]
    [InlineData(100, 100, 60000,0,200000)]


    // test values created in the testing spreadsheet attached to this solution in the tab named "basic buckets sales order test"
    public void SellInvestmentsToDollarAmount_SellsInCorrectOrder(
